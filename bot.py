...
token = "1028737425440260139"
channel_id = 1028738377090072687
...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity=discord.Game(name="Slade_YT#1900 lua obfuscator"))
